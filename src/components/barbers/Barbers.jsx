...
import John1x from '../../images/mobile/John_1x.png';
import John2x from '../../images/mobile/John_2x.png';
import Michele1x from '../../images/mobile/Michele_1x.png';
import Michele2x from '../../images/mobile/Michele_2x.png';
import Alan1x from '../../images/mobile/Alan_1x.png';
import Alan2x from '../../images/mobile/Alan_2x.png';
    ...
    <section className={css.barbers}>
      <div className="container">
        <div className={css.barbersWrapper}>
          ...
          <h3 className={css.barbersTitle}>Our barbers</h3>
          <ul className={css.barbersList}>
            <li className={css.barbersItem}>
              <img
                className={css.barbersImg}
                srcSet={`${John1x}1x ${John2x}2x`}
                src={John1x}
                alt="John"
              />
              <p className={css.barbersName}>John Smith</p>
              <p className={css.barbersProf}>Extreme Barber</p>
              <ul className={css.iconsList}>
                <li className={css.iconsItem}>
                  ...
                  >
                    <g clip-path="url(#clip0_1374_888)">
                      <path
                ...
                <li className={css.iconsItem}>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M13.3313 3.32083H15.1571V0.140833C14.8421 0.0975 13.7588 0 12.4971 0C9.86458 0 8.06125 1.65583 8.06125 4.69917V7.5H5.15625V11.055H8.06125V20H11.6229V11.0558H14.4104L14.8529 7.50083H11.6221V5.05167C11.6229 4.02417 11.8996 3.32083 13.3313 3.32083Z" />
                  </svg>
                </li>
                <li className={css.iconsItem}>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_1374_872)">
                      <path
            ...
            <li className={css.barbersItem}>
              <img
                className={css.barbersImg}
                srcSet={`${Michele1x}1x ${Michele2x}2x`}
                src={Michele1x}
                alt="Michele"
              />
              <p className={css.barbersName}>Michele Doe</p>
              <p className={css.barbersProf}>Extreme Barber</p>
              <ul className={css.iconsList}>
                <li className={css.iconsItem}>
                  <svg
            ...
            <li className={css.barbersItem}>
              <img
                className={css.barbersImg}
                srcSet={`${Alan1x}1x ${Alan2x}2x`}
                src={Alan1x}
                alt="Alan"
              />
              <p className={css.barbersName}>Alan Black</p>
              <p className={css.barbersProf}>Extreme Barber</p>
              <ul className={css.iconsList}>
                <li className={css.iconsItem}>
                  <svg
